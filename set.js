...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    NUMERO_OWNER : process.env.NUMERO_OWNER || "255627417402,255768418867,255625606454",
    ...
    URL: process.env.URL || "https://files.catbox.moe/d83yip.png",  
    ...
    AUTO_STICKER : process.env.AUTO_STICKER || "no", 
    AUTO_STATUS_TEXT: process.env.AUTO_STATUS_TEXT || 'Your Status Seen By VIPERLUVBYTE',   
    ...
    GROUP_LINK: process.env.GROUP_LINK || "https://chat.whatsapp.com/DJMA7QOT4V8FuRD6MpjPpt?mode=ems_copy_t",
    CAPTION : process.env.CAPTION || "VIPERLUVBYTE",
    BOT : process.env.BOT_NAME || 'VIPERLUVBYTE',
